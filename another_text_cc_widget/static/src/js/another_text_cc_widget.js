odoo.define('another_text_cc_widget.another_field_text_cc', function (require) {
"use strict";
    ...
    var AnotherTextCopyClipboard = basic_fields.FieldText.extend(CopyClipboard, {
        //--------------------------------------------------------------------------
        // Private
        //--------------------------------------------------------------------------
         ...
         */
        _render: function() {
            console.log("[another_text_cc_widget.js] function:_render()")
            this._super.apply(this, arguments);
    ...
    registry.add('another_CopyClipboardText', AnotherTextCopyClipboard);
});
